...
const crosswordSets = [
    {
        title: "Zeitung & Nachrichten",
        rows: 15,
        cols: 15,
        words: [
            { id: 1, number: 1, clue: "Gedruckte oder digitale Sammlung von Nachrichten und Artikeln.", answer: "ZEITUNG", row: 1, col: 1, dir: "across" },
            { id: 2, number: 1, clue: "Wörtlich übernommener Satz aus einer Aussage oder einem Text.", answer: "ZITAT", row: 1, col: 1, dir: "down" },
            { id: 3, number: 2, clue: "Überschrift eines Artikels.", answer: "TITEL", row: 1, col: 9, dir: "across" },
            { id: 4, number: 2, clue: "Geschriebener Inhalt eines Artikels.", answer: "TEXT", row: 1, col: 9, dir: "down" },
            { id: 5, number: 3, clue: "Ressort für Fussball, Tennis und andere Wettkämpfe.", answer: "SPORT", row: 8, col: 1, dir: "across" },
            { id: 6, number: 3, clue: "Funktion, mit der man Artikel auf der Website findet.", answer: "SUCHE", row: 8, col: 1, dir: "down" },
            { id: 7, number: 4, clue: "Nachrichten aus der eigenen Stadt oder Umgebung.", answer: "LOKAL", row: 8, col: 9, dir: "across" },
            { id: 8, number: 4, clue: "Person, die einen Artikel liest.", answer: "LESER", row: 8, col: 9, dir: "down" }
        ]
    },
    {
        title: "Schule & Lernen",
        ...
        cols: 15,
        words: [
            { id: 1, number: 1, clue: "Ort, an dem Schülerinnen und Schüler lernen.", answer: "SCHULE", row: 1, col: 1, dir: "across" },
            { id: 2, number: 1, clue: "Damit schreibt man mit Tinte oder Farbe.", answer: "STIFT", row: 1, col: 1, dir: "down" },
            { id: 3, number: 2, clue: "Darin stehen Geschichten, Wissen oder Aufgaben.", answer: "BUCH", row: 1, col: 9, dir: "across" },
            { id: 4, number: 2, clue: "Grosser Papierblock für Notizen oder Zeichnungen.", answer: "BLOCK", row: 1, col: 9, dir: "down" },
            { id: 5, number: 3, clue: "Kurze freie Zeit zwischen zwei Lektionen.", answer: "PAUSE", row: 8, col: 1, dir: "across" },
            { id: 6, number: 3, clue: "Tisch, an dem man in der Schule sitzt.", answer: "PULT", row: 8, col: 1, dir: "down" },
            { id: 7, number: 4, clue: "Person, die den Unterricht erklärt.", answer: "LEHRER", row: 8, col: 9, dir: "across" },
            { id: 8, number: 4, clue: "Hilfsmittel zum Zeichnen gerader Linien.", answer: "LINEAL", row: 8, col: 9, dir: "down" }
        ]
    },
    {
        title: "Natur & Wetter",
        ...
        cols: 15,
        words: [
            { id: 1, number: 1, clue: "Kalte Jahreszeit mit Schnee und Eis.", answer: "WINTER", row: 1, col: 1, dir: "across" },
            { id: 2, number: 1, clue: "Weisse oder graue Ansammlung am Himmel.", answer: "WOLKE", row: 1, col: 1, dir: "down" },
            { id: 3, number: 2, clue: "Wasser, das aus Wolken fällt.", answer: "REGEN", row: 1, col: 9, dir: "across" },
            { id: 4, number: 2, clue: "Grüne Fläche mit Gras, oft im Garten oder Park.", answer: "RASEN", row: 1, col: 9, dir: "down" },
            { id: 5, number: 3, clue: "Heller Stern, der tagsüber Licht und Wärme gibt.", answer: "SONNE", row: 8, col: 1, dir: "across" },
            { id: 6, number: 3, clue: "Sehr starkes windiges Wetter.", answer: "STURM", row: 8, col: 1, dir: "down" },
            { id: 7, number: 4, clue: "Hohe Erhebung in der Landschaft.", answer: "BERG", row: 8, col: 9, dir: "across" },
            { id: 8, number: 4, clue: "Grosse Pflanze mit Stamm, Ästen und Blättern.", answer: "BAUM", row: 8, col: 9, dir: "down" }
        ]
    }
];
...
function buildCrosswordCells(set) {
    ...
    set.words.forEach(word => {
        ...
        letters.forEach((letter, offset) => {
            ...
            if (offset === 0) {
                if (!starts[key]) starts[key] = { number: word.number, dirs: [] };
                starts[key].number = Math.min(starts[key].number, word.number);
                starts[key].dirs.push(word.dir);
            }
        });
    });
    return { cells, starts };
...
function renderCrossword(prefix = "crosswordHome") {
    ...
    const { cells, starts } = buildCrosswordCells(set);
    const isFullscreen = String(prefix).toLowerCase().includes("full");
    const across = set.words.filter(w => w.dir === "across");
    const down = set.words.filter(w => w.dir === "down");
    ...
    return `
        <section class="bg-slate-950 text-white p-6 border border-slate-800 shadow-sm rounded-sm font-sans relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-blue-100 mb-4">Thema: ${set.title}. Die Zahl mit Pfeil im Feld zeigt dir, wo ein Wort beginnt: → waagerecht, ↓ senkrecht. Wenn in einem Feld →↓ steht, starten dort zwei Wörter mit derselben Zahl.</p>
    ...
    modal.innerHTML = `
        <div class="bg-[#fcfbf9] w-full max-w-6xl max-h-[95vh] overflow-y-auto rounded-lg shadow-2xl border border-white/20 p-4 md:p-8 relative">
            ...
            <div class="mb-4 pr-12">
                <h2 class="text-2xl md:text-4xl font-black uppercase tracking-wide font-sans">${titles[type] || "Rätsel"}</h2>

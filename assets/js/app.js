// --- GATEKEEPER KONFIGURATION ---
        ...
        let initialArticles = [
            {
                id: 1,
                title: "Großprojekt im Herzen von Winterthur genehmigt",
                summary: "Das Stadtzentrum von Winterthur steht vor einer historischen Veränderung. Ein neues Begegnungszentrum soll entstehen.",
                content: "Die Stadtplanung hat heute grünes Licht für das größte städtebauliche Projekt des Jahrzehnts gegeben. Am Rande der Altstadt soll ein hochmodernes Kultur- und Begegnungszentrum entstehen, das sowohl grüne Oasen als auch Raum für lokale Startups und Kulturschaffende bietet.\n\nKritiker bemängeln die hohen Kosten, doch Befürworter sprechen von einer Jahrhundert-Chance für das lokale Gewerbe und die Attraktivität Winterthurs als Bildungs- und Kulturstadt.",
                category: "Lokales",
                author: "Redaktion",
                ...
                likes: [],
                comments: [],
                sources: ["https://stadt.winterthur.ch"],
                isEilmeldung: true
            },
            {
                id: 2,
                title: "Wie die Digitalisierung Winterthurs Schulen verändert",
                summary: "Ein Blick in die Klassenzimmer der Zukunft an der MSW und anderen lokalen Instituten.",
                content: "Smartboards, Tablets und KI-Lernassistenten gehören heute in vielen Winterthurer Schulzimmern bereits zum Alltag. Doch wie wirkt sich diese rasante Entwicklung auf den Lernerfolg aus? Lehrkräfte berichten von motivierteren Schülern, warnen jedoch auch vor digitaler Ablenkung.\n\nBesonders praxisorientierte Ausbildungsstätten wie die MSW setzen vermehrt auf hybride Lernkonzepte, um junge Fachkräfte optimal auf die Industrie 4.0 vorzubereiten.",
        ...
        function init3DLogo() {
            ...
            try {
                ...
                const lineMaterial = new THREE.LineBasicMaterial({ color: 0x1e3a8a, linewidth: 1, transparent: true, opacity: 0.4 });
        ...
        function getStandardAvatarHtml(sizeClasses = 'w-8 h-8', iconSize = '') {
            return `<div class="${sizeClasses} shrink-0 bg-gray-200 rounded-full flex items-center justify-center text-gray-400 overflow-hidden shadow-inner border border-gray-300">${getStandardAvatarSvg('', 'width: 60%; height: 60%;')}</div>`;
        }
        ...
        function finalizeModeration(type, id, parentId, status) {
            if (type === 'comment') {
            ...
            <header class="border-b border-gray-300 sticky top-0 bg-[#fcfbf9] z-40">
                <div class="max-w-7xl mx-auto px-3 sm:px-4 py-2 sm:py-4 grid grid-cols-[auto_1fr_auto] items-center gap-2 sm:gap-4">
                    ...
                    <div class="min-w-0 text-center">
                        <h1 onclick="setView('home')" class="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter uppercase font-serif cursor-pointer hover:text-blue-900 transition-colors leading-none">
                            Winterthur Times
                        </h1>
                    </div>
        ...
        function renderGallery() {
            ...
            return `
            <div class="max-w-6xl mx-auto mt-4 font-sans mb-16 px-4">
                ...
                <div class="bg-white p-6 border border-gray-200 shadow-sm rounded-sm mb-12">
                    ${currentUser ? `
        ...
        function renderArticle() {
            ...
            <article class="max-w-4xl mx-auto bg-white p-6 md:p-12 shadow-sm border border-gray-100">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mt-4 mb-6">${article.title}</h1>
        ...
        function renderAuthors() {
            ...
            return `
            <div class="max-w-5xl mx-auto bg-white p-8 md:p-12 shadow-sm border border-gray-100 min-h-[50vh] font-sans px-4">
        ...
        function renderProfile() {
            ...
            return `
            <div class="max-w-4xl mx-auto mt-8 font-sans mb-16 px-4">
                <button onclick="setView('home')" class="flex items-center gap-2 text-blue-600 font-sans font-bold text-sm mb-6 hover:underline cursor-pointer">
                    <i data-lucide="arrow-left" class="w-4 h-4"></i> Zurück zur Startseite
                </button>
        ...
        function renderSearchResults() {
            ...
            let html = `
            <div class="max-w-4xl mx-auto bg-white p-6 md:p-12 shadow-sm border border-gray-100 min-h-[50vh] px-4">
        ...
        function renderFooter() {
            return `
            <footer class="bg-black text-white mt-auto py-12 px-4 font-sans border-t border-gray-800">
                <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h2 class="text-2xl font-black uppercase font-serif mb-4 text-white">Winterthur Times</h2>
            ...
            <div class="fixed inset-0 bg-black/60 flex items-center justify-center z-[70] px-4">
                <div class="bg-white p-8 rounded-sm shadow-xl max-w-sm w-full font-sans">
                    ...
                    ` : currentModal.type === 'register' ? `
                        <div class="flex flex-col gap-3 mb-6 font-sans">
                            <input type="text" id="usernameInput" placeholder="Benutzername" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
                            <input type="text" id="firstNameInput" placeholder="Vorname" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
                            <input type="text" id="lastNameInput" placeholder="Nachname" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
                            <input type="email" id="emailInput" placeholder="E-Mail" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
                            <input type="password" id="passwordInput" placeholder="Passwort" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" />
                            <p id="loginWarning" class="text-red-500 text-sm hidden font-bold mt-1"></p>
                        </div>
                        <div class="flex flex-col gap-3">
        ...
        function renderApp() {
            ...
            // Hier wird das App-HTML in einem flexiblen Container zusammengebaut.
            // "flex-1" auf dem Main-Tag dehnt den Inhalt aus, was den Footer bündig nach unten drückt!
        ...
        window.sendFeedback = function() {
            ...
            siteFeedbacks.push({
                id: newId,
                username: currentUser || 'Gast-' + sessionId,
                text: text,
        ...
        window.loginUser = function() {
            ...
            if (!existingUser) {
                // Erstelle einen neuen Demo-Account auf der Stelle, falls lokal nicht gefunden
                registeredUsers.push({
                    username: username,
                    password: password,
                    firstName: "",
                    lastName: "",
                    email: username + "@beispiel.de",
                    bio: "Leser der Winterthur Times.",
                    profilePicUrl: "",
                    showRealName: false,
                    isBanned: false,
                    isDeleted: false,
        ...
        window.saveProfile = function() {
            ...
            if (user) {
                ...
                window.saveState();
                showModal('Erfolgreich', 'Dein Profil wurde aktualisiert!');
                renderApp();
            }
        }
        ...
        window.deleteComment = function(articleId, commentId) {
            currentModal = {
                ...
                message: 'Möchtest du diesen Kommentar entfernen?',
                onConfirm: function() {
                    const article = articles.find(a => a.id === articleId);
                    if(article) {
                        const comment = article.comments.find(c => c.id === commentId);
            ...
            if(article) {
                ...
                if(comment) {
                    ...
                    if (!comment.reportedBy.includes(currentUser)) {
                        ...
                        window.saveState();
                        showModal('Gemeldet', 'Vielen Dank. Der Kommentar wurde gemeldet.');
                    }
                }
            }
        }

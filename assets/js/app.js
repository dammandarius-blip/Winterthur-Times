...
const crosswordSets = [
    {
        ...
        cols: 13,
        words: [
            { id: 1, number: 1, clue: "Darin liest man Nachrichten und Artikel.", answer: "ZEITUNG", row: 1, col: 1, dir: "across" },
            { id: 2, number: 2, clue: "Die Überschrift eines Artikels.", answer: "TITEL", row: 1, col: 4, dir: "down" },
            { id: 3, number: 3, clue: "Ressort mit Fussball, Tennis und Wettkämpfen.", answer: "SPORT", row: 3, col: 0, dir: "across" },
            { id: 4, number: 4, clue: "Nachrichten aus der eigenen Stadt oder Umgebung.", answer: "LOKAL", row: 5, col: 4, dir: "across" },
            { id: 5, number: 5, clue: "Person, die eine Zeitung oder Website liest.", answer: "LESER", row: 5, col: 8, dir: "down" },
            { id: 6, number: 6, clue: "Bericht über Sonne, Regen und Temperatur.", answer: "WETTER", row: 8, col: 7, dir: "across" }
        ]
    },
    {
        title: "Schule & Lernen",
        ...
        words: [
            ...
            { id: 2, number: 2, clue: "Darin schreibt man Notizen im Unterricht.", answer: "HEFT", row: 1, col: 3, dir: "down" },
            { id: 3, number: 3, clue: "Eine Person, mit der man gerne Zeit verbringt.", answer: "FREUND", row: 3, col: 3, dir: "across" },
            { id: 4, number: 4, clue: "Gebundenes Ding mit vielen Seiten zum Lesen.", answer: "BUCH", row: 2, col: 6, dir: "down" },
            { id: 5, number: 5, clue: "Person, die den Unterricht erklärt.", answer: "LEHRER", row: 5, col: 4, dir: "across" },
            { id: 6, number: 6, clue: "Hilfsmittel zum Zeichnen gerader Linien.", answer: "LINEAL", row: 5, col: 4, dir: "down" }
        ]
    },
    {
        title: "Natur & Wetter",
        ...
        words: [
            ...
            { id: 2, number: 2, clue: "Alles draussen: Pflanzen, Tiere, Berge und Wälder.", answer: "NATUR", row: 1, col: 3, dir: "down" },
            { id: 3, number: 3, clue: "Kleiner Ort oder Gemeinde.", answer: "ORT", row: 3, col: 1, dir: "across" },
            { id: 4, number: 4, clue: "Wasser, das aus Wolken fällt.", answer: "REGEN", row: 0, col: 5, dir: "down" },
            { id: 5, number: 5, clue: "Dichte graue Luft, durch die man schlecht sieht.", answer: "NEBEL", row: 4, col: 5, dir: "across" },
            { id: 6, number: 6, clue: "Hohe Erhebung in der Landschaft.", answer: "BERG", row: 4, col: 7, dir: "down" }
        ]
    }
];
    ...
    return `
        <section class="bg-slate-950 text-white p-6 border border-slate-800 shadow-sm rounded-sm font-sans relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-blue-100 mb-4">Thema: ${set.title}. Die Zahl mit Pfeil im Feld zeigt dir, wo ein Wort beginnt: → waagerecht, ↓ senkrecht.</p>

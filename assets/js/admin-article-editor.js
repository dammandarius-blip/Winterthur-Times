...
(function initAdvancedArticleEditor() {
    ...
    async function saveArticleToFirebase(article) {
        ...
        if (typeof backupArticleList === "function") backupArticleList(articles);
        if (typeof shouldBlockSuspiciousDefaultOverwrite === "function" && shouldBlockSuspiciousDefaultOverwrite(articles)) {
            throw new Error("Speichern blockiert: Die Artikelliste sieht wie ein alter Standardartikel-Reset aus. Bitte Seite neu laden.");
        }
